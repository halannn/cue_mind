...
class _ReminderCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return StreamBuilder<Category?>(
      stream: r.categoryId != null
          ? categoryDao.watchById(r.categoryId!)
          : null,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (r.picturePath != null && r.picturePath!.isNotEmpty)
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8),
                        child: ClipRRect(
                    ...
                    Wrap(
                      ...
                      runSpacing: 8,
                      children: [
                        _buildStatusChip(theme, r.status),

                        if (r.priority != null)
                          _buildPriorityChip(theme, r.priority!),

                        if (r.categoryId != null)
                          _buildCategoryChip(ref, r.categoryId!),
